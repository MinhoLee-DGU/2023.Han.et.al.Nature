...
##scrublet results into seurat obj
doublet.file <- "../#SHH1-8/scrublet.doublet_scores_obs.txt"
...
metadata = data.frame(barcodes = rownames(#SHH1-8@meta.data), #SHH1-8@meta.data)
metadata$barcodes = do.call(rbind, strsplit(rownames(metadata), split = '\\-'))
test <- join(metadata, doublet.df, by = "barcodes")
#SHH1-8@meta.data$Doublet <- test$Doublet
